...
import { Group, useDeleteGroup, useGetGroups } from '../groups.hooks'
                ...
                <Col>
                    <Card>
                      ...
                      <th className="border-0 py-2"> الحالة</th> */}
                                    ...
                                    <tbody>
                                        {!isError && !isLoading && groupsList?.map((group: Group, idx) => (
                                            <tr key={idx}>
                                                {/* <td>
                          <Link to={`/departments/${department.id}`} className="fw-medium">
                            #{department.id}
                                                ...
                                                <td>
                                                    <img src={group.image} alt="user-img" className="avatar-md rounded-circle me-2" />
                                                </td>

                                                <td>
                                                    <div>
                                                        <h5 className="fs-14 mt-1 fw-normal">{group.name?.ar}</h5>
                                                    </div>
                                                </td>
